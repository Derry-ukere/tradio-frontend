        ...
        <div className="mr-5 pr-5 mr-xl-7 pr-xl-7 mb-3 mb-md-0 position-relative">
          <h5 className="slide__title font-size--26 text-color--200 font-w--600">
            <div className="d-flex align-items-center">
              <span className="mr-2"><img src="img/tes6.jpg" alt="avatar" /></span>
              <div className="d-flex flex-column">
                <span className="client-name font-size--17 font-w--600">Stefan Quandt</span>
                <span>ST, GER</span>
              </div>
            </div>
          </h5>
      ...
      <div className="slide slick-slide slick-cloned"  tabIndex={-1} data-slick-index={5} aria-hidden="true">
        <div className="d-md-flex p-3 py-lg-5 pl-lg-4 pr-lg-10">
          ...
          <div>
            ...
            Zunächst darf ich Ihnen dafür danken, dass Sie mir bei dieser brillanten Investition geholfen haben. Ich bin so froh, dass ich mit Ihnen und Ihrem ethischen Unternehmen gegangen bin. Ich liebe es, ein Teil von Tradio zu sein.
            Nochmals alles Lob an Ihr Unternehmen, Sie haben mich bereits sehr unterstützt und es ist wunderbar zu wissen, dass es auch Geschäftsleute gibt, denen Sie vertrauen können.
            </blockquote> 
          </div>
        </div>
      </div>
...
export const QuaterSixMem = React.memo(QuaterSix);
