      ...
      <div className="d-md-flex align-items-md-center">
        ...
        <ul className="pl-2 pl-md-0 ">
          <li className="text-color--400 ">
            <p className="h6-font direct">test INT token on exchanges Approximately 3-month after Main-sale concludes.</p>
          </li>
          <li className="text-color--400">
            <p className="h6-font">Integration of platform in line with blockchain including fiat and cryptocurrency payment methods.</p>
          </li>
          <li className="text-color--400">
            <p className="h6-font">Peer-to-Peer chat option and amalgamation of AI-based dispute system development test again.</p>
          </li>
        </ul>
      </div>
    </div>
