        ...
        <div className="mr-5 pr-5 mr-xl-7 pr-xl-7 mb-3 mb-md-0 position-relative">
          <h5 className="slide__title font-size--26 text-color--200 font-w--600">
            <div className="d-flex align-items-center">
              <span className="mr-2"><img src="img/tes7.jpg" alt="avatar" /></span>
              <div className="d-flex flex-column">
                <span className="client-name font-size--17 font-w--600">W. Anthony</span>
                <span>LA, USA</span>
              </div>
            </div>
          </h5>
      ...
      <div className="slide slick-slide slick-cloned"  tabIndex={-1} data-slick-index={5} aria-hidden="true">
        <div className="d-md-flex p-3 py-lg-5 pl-lg-4 pr-lg-10">
          ...
          <div>
            ...
            Within the first few hours of signing up for Tradio, I had doubled my yearly subscription. The information, the team, and the entire community are always so helpful. I would consider this one of the best crypto communities in the entire space
            </blockquote> 
          </div>
        </div>
      </div>
