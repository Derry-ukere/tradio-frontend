      ...
      <div className="token-saleinfo-dist d-md-flex align-items-md-center reveal">
        <div id="pie-chart--v1" className="
          ...
          <div className="
                          ...
                          pos-abs-center
                      ">
            <span className="font-size--14 font-w--600 mb-1">Total cryptocurrency exchanges </span>
            <span className="font-w--600 mb-1">504 cryptocurrency exchanges </span>
            <span className="font-w--600"></span>
          </div>
